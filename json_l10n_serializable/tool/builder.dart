...
class _NonNullableGenerator extends Generator {
  ...
  FutureOr<String> generate(LibraryReader library, BuildStep buildStep) async {
    ...
    var replacements = [
      ...
      _Replacement(
        "part '$baseName.localization.dart",
        "part '$baseName.non_nullable.localization.dart",
      ),
...
class _CheckedGenerator extends Generator {
  ...
  FutureOr<String> generate(LibraryReader library, BuildStep buildStep) async {
    ...
    var replacements = [
      ...
      _Replacement(
        "part '$baseName.localization.dart",
        "part '$baseName.checked.localization.dart",
      ),
    ];
...
class _WrappedGenerator extends Generator {
  ...
  FutureOr<String> generate(LibraryReader library, BuildStep buildStep) async {
    ...
    var replacements = [
      ...
      _Replacement(
        "part '$baseName.localization.dart",
        "part '$baseName.wrapped.localization.dart",
      ),
    ];
